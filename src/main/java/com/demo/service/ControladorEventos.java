...
public class ControladorEventos {
    ...
    public void notificar(String tipoEvento, List<String> correos, String nombreUsuario, Long solicitudId, String estado){
        List<IEventListener> users = listeners.get(tipoEvento);
        for (IEventListener listener : users) {
              listener.enviarNotificacion(tipoEvento, correos, nombreUsuario,solicitudId,  estado);
        }
    }
